	...
	<div class="col-md-4 col-md-offset-4">
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-danger">
				<div class="panel-heading">
					<h3 class="panel-title">Cek Validasi QR</h3>
				</div>
				<div class="panel-body">
					<p>Untuk melakukan pengecekan QR, pastikan anda menggunakan perangkat yang memiliki kamera seperti laptop/smartphone.</p>
					<a href="./validasi" class="btn btn-danger">Cek Validasi dengan QR Code</a>
				</div>
			</div>
		</div>
</div>
